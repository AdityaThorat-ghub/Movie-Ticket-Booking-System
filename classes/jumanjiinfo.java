...
public class jumanjiinfo extends JFrame implements ActionListener {
    ...
    public jumanjiinfo(String username,String movieName) {
        ...
        textArea.setText("Action , Advanture , Comady \n"+"Movie Name:   Jumanji-Welcome to the Jungle \n"+""+"\nStoryline:   Four teenagers are sucked into a magical video game, and the only way they can escape is to work together to finish the game.\n"+
        "\nDirector:   Jake Kasdan\n"+"\nWriters:   Chris McKenna(screenplay by)Erik Sommers(screenplay by)Scott Rosenberg(screenplay by)\n"+"\nStars:   Dwayne JohnsonKaren GillanKevin Hart\n"+"\nIMDb RATING:   6.9/10\n");
        f=new Font("Arial",Font.BOLD,25);
        textArea.setFont(f);
        add(textArea);
           	
    	icon1 = new ImageIcon("jumanji1.jpg");
