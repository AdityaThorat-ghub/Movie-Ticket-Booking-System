...
public class Shutter_iselandinfo extends JFrame implements ActionListener{
    ...
    public Shutter_iselandinfo( String username,String movieName) {
        ImageIcon icon1;
        Font f;
        JLabel l1;
        ...
        textArea.setText("Mistry , Triller\n"+"Movie Name:   Shutter iseland \n"+""+"\nStoryline:   In 1954, a U.S. Marshal investigates the disappearance of a murderer who escaped from a hospital for the criminally insane.\n"+
        "\nDirector:   Martin Scorsese\n"+"\nWriters:   Laeta Kalogridis(screenplay)Dennis Lehane(novel)\n"+"\nStars:   Leonardo DiCaprioEmily MortimerMark Ruffalo\n"+"\nIMDb RATING:   8.2/10\n");
        f=new Font("Arial",Font.BOLD,25);
        textArea.setFont(f);
        add(textArea);
           	
    	icon1 = new ImageIcon("Shutter_iseland1.jpg");
